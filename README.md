...
- [x] Theory & planned architecture — [Part 1: Architecture](https://github.com/Parsajan/fpga-foc-bldc-pmsm/blob/main/part1-architecture.md)
- [x] Clarke transform + CORDIC — [Part 2: Clarke + CORDIC](https://github.com/Parsajan/fpga-foc-bldc-pmsm/blob/main/part2-clarke-cordic.md)
- [x] Park, PI controller, SVPWM, inverse Park, full-loop integration — [Part 3: Completing the Chain](https://github.com/Parsajan/fpga-foc-bldc-pmsm/blob/main/part3-completing-the-chain.md)
